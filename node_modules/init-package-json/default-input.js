...
function readDeps (test) { return function (cb) {
  fs.readdir('unity_packages', function (er, dir) {
    if (er) return cb()
    var deps = {}
    var n = dir.length
    ...
    dir.forEach(function (d) {
      ...
      var dp = path.join(dirname, 'unity_packages', d, 'package.json')
...
if (!package.scripts) {
  exports.scripts = function (cb) {
    fs.readdir(path.join(dirname, 'unity_packages'), function (er, d) {
      setupScripts(d || [], cb)
    })
  }
}
