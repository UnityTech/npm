...
var data = [{
  name: "glob@3.2.9",
  paths: [
    "unity_packages/tap/unity_packages/glob",
    "unity_packages/tape/unity_packages/glob"
  ].join('\n')
}, {
  name: "nopt@2.2.1",
  paths: [
    "unity_packages/tap/unity_packages/nopt"
  ]
}, {
  name: "runforcover@0.0.2",
  paths: "unity_packages/tap/unity_packages/runforcover"
}]
...
```
NAME              PATHS
glob@3.2.9        unity_packages/tap/unity_packages/glob
                  unity_packages/tape/unity_packages/glob
nopt@2.2.1        unity_packages/tap/unity_packages/nopt
runforcover@0.0.2 unity_packages/tap/unity_packages/runforcover
```
...
```
NAME              PATHS
glob@3.2.9        unity_packages/tap/unity_packages/glob unity_packages/tape/unity_packages/glob
nopt@2.2.1        unity_packages/tap/unity_packages/nopt
runforcover@0.0.2 unity_packages/tap/unity_packages/runforcover
```
