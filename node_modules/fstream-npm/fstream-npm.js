...
function Packer (props) {
  ...
  // only do the magic bundling stuff for the unity_packages folder that
  // lives right next to a package.json file.
  this.bundleMagic = this.parent &&
                     this.parent.packageRoot &&
                     this.basename === 'unity_packages'

  // in a unity_packages folder, resolve symbolic links to
...
Packer.prototype.readBundledLinks = function () {
  ...
  this.pause()
  fs.readdir(this.path + '/unity_packages', function (er, list) {
    ...
    list.forEach(function (pkg) {
      ...
      var pd = this.path + '/unity_packages/' + pkg
...
Packer.prototype.getChildProps = function (stat) {
  ...
  // only follow symbolic links directly in the unity_packages folder.
  props.follow = false
  return props
}
...
Packer.prototype.sort = function (a, b) {
  ...
  // deps go in the back
  if (a === 'unity_packages') return 1
  if (b === 'unity_packages') return -1
