...
/*
This will traverse through all unity_packages folders,
...
, dependencies:
  { foo :
    { version: "1.2.3"
    , path: "/path/to/unity_packages/foo"
    , parent: <Circular: root>
    , dependencies:
      { bar:
        { parent: <Circular: foo>
        , path: "/path/to/unity_packages/foo/unity_packages/bar"
        , version: "2.3.4"
...
for each folder in installed
  obj.dependencies[folder] = READ(packagefolder+unity_packages+folder,
...
as far as the left-most unity_packages folder.
2. Ignore anything in unity_packages that isn't a package folder.
...
function readInstalled_ (folder, parent, name, reqver, depth, opts, cb) {
  ...
  readdir(path.resolve(folder, "unity_packages"), function (er, i) {
  ...
  function next (er) {
    ...
    asyncMap(installed, function (pkg, cb) {
      ...
      readInstalled_( path.resolve(folder, "unity_packages/"+pkg)
