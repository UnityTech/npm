...
function findNodeDirectory(scriptLocation, processObj) {
  ...
  if (path.basename(npm_parent_directory) === 'deps') {
    ...
    // deps/npm/unity_packages/node-gyp/lib
    node_root_dir = path.join(npm_parent_directory, '..')
    log.verbose('node-gyp root', 'in build directory, root = '
                + node_root_dir)
  } else if (path.basename(npm_parent_directory) === 'unity_packages') {
    // We are in a node install directory where this script lives in
    // lib/unity_packages/npm/unity_packages/node-gyp/lib or
    // unity_packages/npm/unity_packages/node-gyp/lib depending on the
    // platform
